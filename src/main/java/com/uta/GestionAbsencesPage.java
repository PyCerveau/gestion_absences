...
public class GestionAbsencesPage extends JFrame{
    ...
    public GestionAbsencesPage(String ecole, String user, String anneeScolaire) {
        this.ecole = ecole;
        this.user = user;
    ...
    public void showPage() {
        ...
        JLabel adminLabel = new JLabel("Administrateur: " + user);
...
// Menu latéral
        ...
        menuLateral.setBackground(new Color(72, 99, 138)); // Vert foncé
...
// Création des boutons avec icônes et texte alignés
        ...
        JButton btnGestionEtudiant = createMenuButton("Gestion des Etudiants", "src/main/java/com/uta/icons/graduated.png");
        JButton btnGestionEnseignant = createMenuButton("Gestion des Enseignants", "src/main/java/com/uta/icons/teacher.png");
        JButton btnGestionClasse = createMenuButton("Gestion des classes", "src/main/java/com/uta/icons/teaching.png");
        JButton btnGestionListeClasse = createMenuButton("Gestion des séances", "src/main/java/com/uta/icons/to-do-list.png");
...
// Ajouter les boutons au menu latéral avec espacement uniforme
        for (JButton button : buttons) {
            ...
            menuLateral.add(Box.createRigidArea(new Dimension(0, 15))); // Espacement entre les boutons
        }
...
// Panel principal pour le contenu
    ...
    btnGestionUtilisateur.addActionListener(e -> showPanel("Gestion des séances", new GestionUtilisateurPanel()));

    btnGestionEnseignant.addActionListener(e -> showPanel("Gestion des Enseignants", new GestionEnseignant()));

    try {
        // Tentative de connexion à la base de données
        Connection connection = DatabaseConnection.getConnection();

        // Ajout de l'action pour le bouton "Gestion des classes"
    ...
    private void redirectToMain() {
        // Rendre l'instance actuelle invisible

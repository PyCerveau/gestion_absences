...
public class EtudiantDashboard extends JFrame {
    ...
    public EtudiantDashboard(String ecole, String user, String anneeScolaire){
        this.ecole = ecole;
        this.user = user;
    ...
    public void showPage() {
        ...
        JLabel adminLabel = new JLabel("Etudiant: " + user);
...
// Création des boutons avec icônes et espacement
        ...
        JButton btnProfile = createMenuButton("Profil", "src/main/java/com/uta/icons/a.png");
...
// Liste des boutons à ajouter
        JButton[] buttons = {btnStatistiques, btnProfile, btnConsulterAbsences, btnGestionAbout, btnDeconnexion};

// Ajouter les boutons au menu latéral avec espacement uniforme
        for (JButton button : buttons) {
            button.setAlignmentX(Component.CENTER_ALIGNMENT); // Centrer les boutons sur l'axe X
